 ...
 */
abstract class Bestwebsite_Object_Choice_Field extends Bestwebsite_Choice_Field {
	/**
	 * Show field HTML.
	...
	public static function show( $field, $saved, $post_id = 0 ) {
		...
		$meta = Bestwebsite_Helpers_Array::flatten( (array) $meta );
	...
	public static function get_attributes( $field, $value = null ) {
		...
		if ( 'select_advanced' === $field['field_type'] ) {
			$attributes['class'] .= ' Bestwebsite-select_advanced';
		} elseif ( 'select' === $field['field_type'] ) {
			$attributes['class'] .= ' Bestwebsite-select';
		}
		return $attributes;
	}
	...
	public static function admin_enqueue_scripts() {
		Bestwebsite_Input_List_Field::admin_enqueue_scripts();
		Bestwebsite_Select_Field::admin_enqueue_scripts();
		Bestwebsite_Select_Tree_Field::admin_enqueue_scripts();
		Bestwebsite_Select_Advanced_Field::admin_enqueue_scripts();
	}
	...
	protected static function get_type_class( $field ) {
		return Bestwebsite_Helpers_Field::get_class(
			array(
