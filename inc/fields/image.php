 ...
 */
class Bestwebsite_Image_Field extends Bestwebsite_File_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_media();
		wp_enqueue_style( 'Bestwebsite-image', Bestwebsite_CSS_URL . 'image.css', array(), Bestwebsite_VER );
	}
	...
	protected static function file_html( $file, $index, $field ) {
		...
		if ( $edit_link ) {
			$edit_link = sprintf( '<a href="%s" class="Bestwebsite-image-edit" target="_blank"><span class="dashicons dashicons-edit"></span></a>', $edit_link );
		}

		return sprintf(
			'<li class="Bestwebsite-image-item attachment %s">
				...
				<div class="Bestwebsite-image-actions">
					%s
					<a href="#" class="Bestwebsite-image-delete Bestwebsite-file-delete" data-attachment_id="%s"><span class="dashicons dashicons-no-alt"></span></a>
				</div>
			</li>',
