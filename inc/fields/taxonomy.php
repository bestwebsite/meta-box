 ...
 */
class Bestwebsite_Taxonomy_Field extends Bestwebsite_Object_Choice_Field {
	/**
	 * Add ajax actions callback.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_Bestwebsite_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
		add_action( 'wp_ajax_nopriv_Bestwebsite_get_terms', array( __CLASS__, 'ajax_get_terms' ) );
	}
	...
	protected static function add_term( $field ) {
		$term = Bestwebsite_request()->post( $field['id'] . '_new' );
	...
	public static function add_new_form( $field ) {
		...
		$html = '
		<div class="Bestwebsite-taxonomy-add">
			<button class="Bestwebsite-taxonomy-add-button">%s</button>
			<div class="Bestwebsite-taxonomy-add-form Bestwebsite-hidden">
	...
	public static function admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'Bestwebsite-taxonomy', Bestwebsite_CSS_URL . 'taxonomy.css', array(), Bestwebsite_VER );
		wp_enqueue_script( 'Bestwebsite-taxonomy', Bestwebsite_JS_URL . 'taxonomy.js', array( 'jquery' ), Bestwebsite_VER, true );
