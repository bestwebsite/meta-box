 ...
 * User field class.
 */
class Bestwebsite_User_Field extends Bestwebsite_Object_Choice_Field {
	/**
	 * Add actions.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_Bestwebsite_get_users', array( __CLASS__, 'ajax_get_users' ) );
		add_action( 'wp_ajax_nopriv_Bestwebsite_get_users', array( __CLASS__, 'ajax_get_users' ) );
