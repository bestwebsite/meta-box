 ...
 * OEmbed field class.
 */
class Bestwebsite_OEmbed_Field extends Bestwebsite_Text_Field {
	/**
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'Bestwebsite-oembed', Bestwebsite_CSS_URL . 'oembed.css', '', Bestwebsite_VER );
		wp_enqueue_script( 'Bestwebsite-oembed', Bestwebsite_JS_URL . 'oembed.js', array( 'jquery', 'underscore' ), Bestwebsite_VER, true );
	}
	...
	public static function add_actions() {
		add_action( 'wp_ajax_Bestwebsite_get_embed', array( __CLASS__, 'wp_ajax_get_embed' ) );
	}
	...
	public static function get_embed( $url, $not_available = '' ) {
		...
		if ( $not_available ) {
			$not_available = '<div class="Bestwebsite-oembed-not-available">' . wp_kses_post( $not_available ) . '</div>';
		}
		$not_available = apply_filters( 'Bestwebsite_oembed_not_available_string', $not_available );
	...
	public static function html( $meta, $field ) {
		return parent::html( $meta, $field ) . sprintf(
			...
			<div class="Bestwebsite-embed-media">%s</div>',
