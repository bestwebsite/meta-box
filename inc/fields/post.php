 ...
 * Post field class.
 */
class Bestwebsite_Post_Field extends Bestwebsite_Object_Choice_Field {
	/**
	 * Add ajax actions callback.
	 */
	public static function add_actions() {
		add_action( 'wp_ajax_Bestwebsite_get_posts', array( __CLASS__, 'ajax_get_posts' ) );
		add_action( 'wp_ajax_nopriv_Bestwebsite_get_posts', array( __CLASS__, 'ajax_get_posts' ) );
	}
