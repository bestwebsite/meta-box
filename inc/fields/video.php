 ...
 */
class Bestwebsite_Video_Field extends Bestwebsite_Media_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		parent::admin_enqueue_scripts();
		wp_enqueue_style( 'Bestwebsite-video', Bestwebsite_CSS_URL . 'video.css', array( 'Bestwebsite-media' ), Bestwebsite_VER );
		wp_enqueue_script( 'Bestwebsite-video', Bestwebsite_JS_URL . 'video.js', array( 'Bestwebsite-media' ), Bestwebsite_VER, true );
		Bestwebsite_Helpers_Field::localize_script_once(
			'Bestwebsite-video',
			'i18nBestwebsiteVideo',
			array(
	...
	public static function print_templates() {
		...
		require_once Bestwebsite_INC_DIR . 'templates/video.php';
	}
}
