 ...
 */
class Bestwebsite_Taxonomy_Advanced_Field extends Bestwebsite_Taxonomy_Field {
	/**
	...
	public static function save( $new, $old, $post_id, $field ) {
		...
		Bestwebsite_Field::save( $new, $old, $post_id, $field );
	}
	...
	public static function raw_meta( $object_id, $field, $args = array() ) {
		$args['single'] = true;
		$meta           = Bestwebsite_Field::raw_meta( $object_id, $field, $args );
