 ...
 */
class Bestwebsite_Text_List_Field extends Bestwebsite_Multiple_Values_Field {
	/**
	 * Enqueue scripts and styles.
	 */
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'Bestwebsite-text-list', Bestwebsite_CSS_URL . 'text-list.css', '', Bestwebsite_VER );
	}
	...
	public static function html( $meta, $field ) {
		...
		$html  = array();
		$input = '<label><span class="Bestwebsite-text-list-label">%s</span> <input type="text" class="Bestwebsite-text-list" name="%s" value="%s" placeholder="%s"></label>';
	...
	public static function normalize( $field ) {
		...
		if ( ! $field['clone'] ) {
			$field['class'] .= ' Bestwebsite-text_list-non-cloneable';
		}
		return $field;
	}
