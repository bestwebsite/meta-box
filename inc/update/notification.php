 ...
 * @package Meta Box
 */
class Bestwebsite_Update_Notification {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'mb-notification', Bestwebsite_JS_URL . 'notification.js', array( 'jquery' ), Bestwebsite_VER, true );
	...
	public function plugin_links( $links ) {
		...
		$links[] = '<a href="' . esc_url( $this->settings_page ) . '" class="Bestwebsite-activate-license" style="color: #39b54a; font-weight: bold">' . esc_html( $text ) . '</a>';
