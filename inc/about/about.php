...
class Bestwebsite_About {
				...
				<div id="post-body" class="metabox-holder columns-2">
					<div id="post-body-content">
						<div class="about-wrap">
							...
							do_action( 'Bestwebsite_about_tabs_content' );
							?>
						</div>
					</div>
	...
	public function enqueue() {
		wp_enqueue_style( 'meta-box-about', Bestwebsite_URL . 'inc/about/css/about.css', array(), Bestwebsite_VER );
		wp_enqueue_script( 'meta-box-about', Bestwebsite_URL . 'inc/about/js/about.js', array( 'jquery' ), Bestwebsite_VER, true );
	}
	...
	public function redirect( $plugin, $network_wide = false ) {
		...
		$is_bulk_activate = 'activate-selected' === Bestwebsite_request()->post( 'action' ) && count( Bestwebsite_request()->post( 'checked' ) ) > 1;
	...
	protected function has_menu() {
		return apply_filters( 'Bestwebsite_admin_menu', false );
	}
