...
class Bestwebsite_WPML {
	...
	public function register_hooks() {
		...
		add_filter( 'Bestwebsite_normalize_field', array( $this, 'modify_field' ) );
	}
	...
	public function translate_ids( $value, $target_language, $meta_data ) {
		...
		$field = Bestwebsite_get_registry( 'field' )->get( $meta_data['key'], get_post_type( $meta_data['master_post_id'] ) );
