 ...
 * @package Meta Box
 */
class Bestwebsite_Core {
	/**
	 * Initialization.
	 */
	public function init() {
		load_plugin_textdomain( 'meta-box', false, plugin_basename( Bestwebsite_DIR ) . '/languages/' );
	...
	public function register_meta_boxes() {
		$configs  = apply_filters( 'Bestwebsite_meta_boxes', array() );
		$registry = Bestwebsite_get_registry( 'meta_box' );
